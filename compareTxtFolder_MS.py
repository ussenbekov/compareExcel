...
class CompareTxtFolder:
    ...
    def compare_files(self, file_1, file_2):
        ...
        join_columns.remove("VALUE")

        var_df = df1.merge(df2, how="outer", on=join_columns, suffixes=("_1", "_2"))
        ...
        var_df["var"] = round(var_df["VALUE_1"] - var_df["VALUE_2"], 5)
